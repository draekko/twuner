...
%description
Twuner is a multi-column microblogging client written by HTML5 technologies through Webkit, thus can run on any device supports webkit(Currently runs on Windows/Linux/Mac OS X/Google Chrome/QT Mobiles).
...
This package provides Twuner QT edition with KDE integration.

%package data
Summary: A lightweight, flexible microblogging client
Group:  Productivity/Networking/Instant Messenger
Recommends: twuner-gtk = %{version}
Recommends: twuner-gir = %{version}
Recommends: twuner-qt = %{version}
...
/Locales/Extensions/Sound) for Twuner.
...
This package provides Twuner GTK2 edition.
...
This package provides Twuner GTK3 edition with Gir.
%endif
%else
...
%{_datadir}/kde4/apps/desktoptheme/default/icons/twuner_qt.svg
