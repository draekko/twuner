...
vars: {
    ...
    , 'version': '1.0.0'
    , 'codename': 'Twuner'
    , 'consumer_key': 'uLv2EKZkCgK9EDM4Dtw9qcYMb'
    , 'consumer_secret': '9Yh0HUKf1IjF8G3WvzqC4pv342BurYavOnukw6iJllDbsartKJ'
...
default_prefs: {
    'twitter': {
        ...
        , 'exts_enabled': ["org.twuner.imagepreview", "org.twuner.gmap", "org.twuner.translate", "org.twuner.imageupload", "org.twuner.videopreview", "org.twuner.shorturl", "org.twuner.cfw"]
        , 'kismet_rules': []
...
function load_native_options(options) {
    twuner_action('system/load_native_options'); 
},
