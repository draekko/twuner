// org.twuner.expandurls - twuner extension to expand shortened urls (refs #368)
...
longurl_service:
    {
        name: 'longurlplease',
        service_url: 'http://api.longurl.org/v2/expand?user-agent=Twuner&format=json&url=',
        ...
        // I do not understand; it is probably some twuner magic :-)
        ...
        while (match != null)
        {
            ...
            $.ajax({
                ...
                , success: function (results) {
                    ...
                    twuner_log('ExpandUrls', this.short_url + ' : ' + long_url);
