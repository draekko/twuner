...
builtins: [
    ...
    , 'org.twuner.sample'
    , 'org.twuner.shorturl'
    , 'org.twuner.expandurls'
    , 'org.twuner.translate'
    , 'org.twuner.stat'
    , 'org.twuner.appmask'
    , 'org.twuner.imghp'
],
...
init:
function init() {
    ext.prefs = window.openDatabase('twuner.exts_prefs', '', 'Preferences of extensions', 10);
    // listeners: {listener_type: [callbacks ... ], ... };
...
function init_exts() {
    ...
    for (var key in ext) {
        ...
        if (65 <= key.charCodeAt(0)
            ...
            twuner_log('Init Extension', extension.name);
        }
    }
},
...
function disable_ext(id){
    try{
        ...
        twuner_log('error:disable_ext()', e)
    }
},
    ...
    var _load = function (idx) {
        ...
        procs.push(function () {
            ...
            script.onload = function() {
                twuner_log('Load Extension', path);
...
ext.Preferences = function (prefs_name) {
    ...
    function get(key, callback) {
        ...
        ext.prefs.transaction(function (tx) {
            ...
            function (tx, error) {
                twuner_log('EXT', 'sql:'+ error.message);
            });
        });
    }
