...
#ifndef TWUNERREQUEST_H
#define TWUNERREQUEST_H
...
class TwunerRequest : public QObject
{
    Q_OBJECT
public:
    TwunerRequest(const QString& uuid,
    ...
    bool doRequest();
Q_SIGNALS:
    void requestFinished(TwunerRequest* request, QByteArray result, QString uuid, bool hasError);
protected Q_SLOTS:
    void finished();
private:
